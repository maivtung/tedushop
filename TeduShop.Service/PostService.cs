...
namespace TeduShop.Service
{
    ...
    public class PostService : IPostService
    {
        ...
        {
            return _postRepostory.GetMultiPaging(x => x.Status && x.CategoryID == categoryId, out totalRow, page, pageSize,new string[] { "PostCategory" });
        }

        public IEnumerable<Post> GetAllByTagPaging(string tag,int page, int pageSize, out int totalRow)
        {
            return _postRepostory.GetAllByTag(tag ,page, pageSize, out totalRow);
        }
